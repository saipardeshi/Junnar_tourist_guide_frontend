...
const styles = {
  page: { background: "#0a0a0a", minHeight: "100vh", padding: "clamp(1.5rem, 4vw, 3rem) clamp(1rem, 3vw, 2rem)", maxWidth: "1200px", margin: "0 auto" },
  ...
  searchBox: { display: "flex", alignItems: "center", background: "#111", border: "1px solid #2a2a2a", borderRadius: "10px", overflow: "hidden", maxWidth: "480px", width: "100%", margin: "0 auto" },
  searchInput: { flex: 1, minWidth: "0", padding: "0.85rem 0.5rem", background: "transparent", border: "none", color: "#fff", fontSize: "0.95rem" },
  searchBtn: { padding: "0.85rem 1.4rem", background: "#ff6b00", border: "none", color: "#fff", fontWeight: "700", fontSize: "0.9rem", cursor: "pointer", whiteSpace: "nowrap" },
