...
export default function Herosection() {
  ...
  align-items: center;
        ...
        @media (max-width: 900px) {
          ...
          .dj-inner { flex-direction: column; gap: 48px; }
          ...
          <div className="dj-inner">
            ...
            <div className={`dj-right${heroVisible ? " vis" : ""}`}>
              <div style={{
                position: 'relative',
                borderRadius: '28px',
                background: 'radial-gradient(ellipse at center, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.65) 60%, rgba(0,0,0,0.3) 100%)',
                backdropFilter: 'blur(12px)',
                WebkitBackdropFilter: 'blur(12px)',
                boxShadow: 'inset 0 0 60px rgba(0,0,0,0.3), 0 8px 40px rgba(0,0,0,0.4)',
