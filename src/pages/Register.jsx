...
const styles = {
  ...
  leftTitle: { fontFamily: "'Bebas Neue', sans-serif", fontSize: "4rem", color: "#ff6b00", letterSpacing: "0.1em" },
  leftSub: { color: "#555", fontSize: "0.95rem", marginBottom: "2.5rem" },
  perks: { display: "flex", flexDirection: "column", gap: "0.8rem", alignItems: "flex-start" },
  perk: {
    display: "flex", gap: "0.8rem", alignItems: "center",
    background: "rgba(255,107,0,0.06)", border: "1px solid rgba(255,107,0,0.1)",
    padding: "0.6rem 1.2rem", borderRadius: "8px", width: "100%",
  },
  right: {
  ...
  formSub: { color: "#555", fontSize: "0.88rem", marginBottom: "2rem", marginTop: "0.3rem" },
  error: {
