...
const styles = {
  ...
  header: { display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "1rem", marginBottom: "2.5rem" },
  ...
  formCard: { background: "#111", border: "1px solid #1e1e1e", borderRadius: "16px", padding: "clamp(1.2rem, 3vw, 2rem)", marginBottom: "2rem" },
  ...
  placeGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: "0.5rem", marginTop: "0.5rem" },
